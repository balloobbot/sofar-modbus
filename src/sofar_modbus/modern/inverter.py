...
class GridOutput(SofarComponent):
    ...
    reactive_power_output_total = gauge(0x0486, 0.01, signed=True, unit="var")
    apparent_power_output_total = gauge(0x0487, 0.01, signed=True, unit="VA")
    active_power_pcc_total = gauge(0x0488, 0.01, signed=True, unit="kW")
    reactive_power_pcc_total = gauge(0x0489, 0.01, signed=True, unit="var")
    apparent_power_pcc_total = gauge(0x048A, 0.01, signed=True, unit="VA")
    ...
    reactive_power_output_l1 = gauge(0x0490, 0.01, signed=True, unit="var")
    ...
    reactive_power_pcc_l1 = gauge(0x0494, 0.01, signed=True, unit="var")
    ...
    reactive_power_output_l2 = gauge(0x049B, 0.01, signed=True, unit="var")
    ...
    reactive_power_pcc_l2 = gauge(0x049F, 0.01, signed=True, unit="var")
    ...
    reactive_power_output_l3 = gauge(0x04A6, 0.01, signed=True, unit="var")
    ...
    reactive_power_pcc_l3 = gauge(0x04AA, 0.01, signed=True, unit="var")
