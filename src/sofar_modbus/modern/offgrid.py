...
class OffGridSinglePhase(SofarComponent):
    ...
    offgrid_loadpeakratio = gauge(0x050F, 0.01, signed=False)
...
class OffGridThreePhase(SofarComponent):
    ...
    offgrid_loadpeakratio_l1 = gauge(0x050F, 0.01, signed=False)
    ...
    offgrid_loadpeakratio_l2 = gauge(0x0517, 0.01, signed=False)
    ...
    offgrid_loadpeakratio_l3 = gauge(0x051F, 0.01, signed=False)
