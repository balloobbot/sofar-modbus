...
class OffGridTotals(SofarComponent):
    ...
    reactive_power_offgrid_total = gauge(0x0505, 0.01, signed=True, unit="var")
    apparent_power_offgrid_total = gauge(0x0506, 0.01, signed=True, unit="VA")
...
class OffGridSinglePhase(SofarComponent):
    ...
    offgrid_reactive_power_output = gauge(0x050D, 0.01, signed=True, unit="var")
    offgrid_apparent_power_output = gauge(0x050E, 0.01, signed=True, unit="VA")
    offgrid_loadpeakratio = gauge(0x050F, 0.01, signed=False, unit="VA")
...
class OffGridThreePhase(SofarComponent):
    ...
    offgrid_reactive_power_output_l1 = gauge(0x050D, 0.01, signed=True, unit="var")
    offgrid_apparent_power_output_l1 = gauge(0x050E, 0.01, signed=True, unit="VA")
    offgrid_loadpeakratio_l1 = gauge(0x050F, 0.01, signed=False, unit="VA")
    ...
    offgrid_reactive_power_output_l2 = gauge(0x0515, 0.01, signed=True, unit="var")
    offgrid_apparent_power_output_l2 = gauge(0x0516, 0.01, signed=True, unit="VA")
    offgrid_loadpeakratio_l2 = gauge(0x0517, 0.01, signed=False, unit="VA")
    ...
    offgrid_reactive_power_output_l3 = gauge(0x051D, 0.01, signed=True, unit="var")
    offgrid_apparent_power_output_l3 = gauge(0x051E, 0.01, signed=True, unit="VA")
    offgrid_loadpeakratio_l3 = gauge(0x051F, 0.01, signed=False, unit="VA")
